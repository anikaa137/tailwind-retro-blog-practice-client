           ...
           <div >
            ...
            <div class="mb-3 col-md-9 mx-auto">
                ...
                <div class="mx-auto" style={{width: "200px"}}>
                            ...
                            <button type="submit" class="border border-indigo-500 bg-indigo-500 text-white rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-indigo-600 focus:outline-none focus:shadow-outline">Save and Publish </button>
                </div>
            </form>
            </div>
